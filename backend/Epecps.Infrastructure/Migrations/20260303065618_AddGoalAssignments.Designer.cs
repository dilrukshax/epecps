...
namespace Epecps.Infrastructure.Migrations
{
    ...
    [Migration("20260303065618_AddGoalAssignments")]
    partial class AddGoalAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Epecps.Domain.Entities.GoalAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Epecps.Domain.Entities.ReviewScoreHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReviewScoreHistory", (string)null);
                });
            ...
            modelBuilder.Entity("Epecps.Domain.Entities.GoalAssignment", b =>
                {
                    b.HasOne("Epecps.Domain.Entities.User", "AssignedByUser")
                        .WithMany("GoalAssignmentsMade")
                        .HasForeignKey("AssignedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Epecps.Domain.Entities.User", "AssignedToUser")
                        .WithMany("GoalAssignmentsReceived")
            ...
            modelBuilder.Entity("Epecps.Domain.Entities.User", b =>
                {
                    b.Navigation("GoalAssignmentsMade");

                    b.Navigation("GoalAssignmentsReceived");
