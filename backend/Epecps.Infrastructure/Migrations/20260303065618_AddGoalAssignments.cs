...
{
    /// <inheritdoc />
    public partial class AddGoalAssignments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GoalSetId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoalAssignments_PersonalGoals_PersonalGoalId",
                        column: x => x.PersonalGoalId,
                        principalTable: "PersonalGoals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_GoalAssignments_ScoreItems_GoalItemId",
                        column: x => x.GoalItemId,
                        principalTable: "ScoreItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GoalAssignments_Users_AssignedByUserId",
                        column: x => x.AssignedByUserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_GoalAssignments_Users_AssignedToUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoalAssignments_AssignedByUserId",
                table: "GoalAssignments",
                column: "AssignedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GoalAssignments_AssignedToUserId",
                table: "GoalAssignments",
                column: "AssignedToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GoalAssignments_GoalItemId",
                table: "GoalAssignments",
                column: "GoalItemId");

            migrationBuilder.CreateIndex(
                name: "IX_GoalAssignments_GoalSetId",
                table: "GoalAssignments",
                column: "GoalSetId");

            migrationBuilder.CreateIndex(
                name: "IX_GoalAssignments_PersonalGoalId",
                table: "GoalAssignments",
                column: "PersonalGoalId");
